...
[assembly: OwinStartup(typeof(DomainService.Startup))]
    ...
    public class Startup
    {
        public void Configuration(IAppBuilder app)
        {
            GlobalConfiguration.Configure(config =>
            {
                ...
                var domainsEventBusMessageHandler = container.Resolve<IDomainsEventBusMessageHandler>();
                client.OnMessage(message =>
                {
                    try
                    {
                        ...
                        domainsEventBusMessageHandler.Handle(messageBodyObject);
